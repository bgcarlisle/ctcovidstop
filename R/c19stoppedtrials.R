...
#'
#' The set of trials that stopped during the pandemic contains trials
#' with stop dates from 2019-12-01 to 2022-11-30. This data set was
#' last updated for trials that stopped on 2022-12-20, and last
#' checked for a restart date on 2023-12-20 to allow for at least one
#' year of follow from the time the trial stopped.
#'
#' @format A tibble with 13,323 rows and 8 variables:
#' \describe{
